-- Cleanup
DROP DATABASE IF EXISTS petstoreDBExam;
CREATE DATABASE petstoreDBExam;
USE petstoreDBExam;
...
customer_fk VARCHAR(10) NOT NULL, INDEX customer_fk_ind (customer_fk), FOREIGN KEY (customer_fk) REFERENCES T_CUSTOMER(id)
) ENGINE=INNODB;
