        ...
        <td align="right" valign="middle">
            ...
            <c:choose>
                <c:when test="${empty sessionScope.customerDTO}">
            		<a href="<%= request.getContextPath() %>/searchcomments">Show all comments</a> |
                    <a href="<%= request.getContextPath() %>/signon.jsp">Sign on</a>
                </c:when>
                <c:otherwise>
            		<a href="<%= request.getContextPath() %>/customer.jsp">Account</a> |
            		<a href="<%= request.getContextPath() %>/createcomment.jsp">Create Comment</a> |
            		<a href="<%= request.getContextPath() %>/searchcomments">Show my comments</a> |
